      ...
      <SafeAreaView className="flex-1 bg-[#fff]">
        <View className="p-5">
          <View className="flex items-center ">
            ...
            <Text
              className="text-[#322B8C] text-[36px]"
              style={styles.boldFont}
            >
              Welcome!
            </Text>
            <Text
              className="text-[#6E717C] text-[20px] font-light p-5 text-center leading-[30px]"
          ...
          <View className="flex  gap-y-5 mt-1">
            <View>
              <View className="bg-[#F9FAFC] rounded-[20px] border-[#EFF2F7] border-2">
                <TextInput
            ...
            <View>
              <View className="flex  flex-row bg-[#F9FAFC] rounded-[20px] border-[#EFF2F7] border-2  items-center relative">
                <TextInput
                  className="mt-1 "
                  label="Password"
